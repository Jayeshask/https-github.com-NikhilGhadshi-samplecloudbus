        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="images/i.jpg" alt="Image" class="img-fluid" style="height: 353px">
              <div class="unit-1-text">
                <h3 class="unit-1-heading">Pratiksha Angchekar</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="images/i.jpg" alt="Image" class="img-fluid" style="height: 353px">
              <div class="unit-1-text">
                <h3 class="unit-1-heading">Bhagyashree Gangan</h3>
              </div>
            </a>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
            <a href="#" class="unit-1 text-center">
              <img src="images/i.jpg" alt="Image" class="img-fluid" style="height: 353px">
              <div class="unit-1-text">
                <h3 class="unit-1-heading">Nikhil Ghadshi</h3>
              </div>
            </a>
          </div>
        </div>
